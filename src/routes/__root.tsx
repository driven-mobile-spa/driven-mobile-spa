...
/**
 * Observes every `[data-reveal]` element on the page and sets
 * `data-revealed="true"` when it enters the viewport. This acts as a
 * backstop for components that mark children with `data-reveal` without
 * assigning a `useReveal` ref to each one, and it watches the DOM so
 * client-side route changes also get revealed.
 */
